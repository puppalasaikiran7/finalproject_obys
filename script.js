...
function cursoranimation(){
    ...
    let videocontainer = document.querySelector("#video-part1");
    ...
    var video = document.querySelector("#video-part1 video");
...
function sher(){
    Shery.makeMagnet("#nav-part2 h4 , .menu-opener__square" /* Element to target.*/, {
